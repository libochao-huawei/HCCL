...
#ifndef OPS_HCCL_SYMMETRIC_ALLTOALL_COMMON_H
#define OPS_HCCL_SYMMETRIC_ALLTOALL_COMMON_H
...
constexpr uint32_t MAX_PEER_RANKS = 16;
...
struct OpParam {
    ...
    // Symmetric window fields
    void* sendBuf = nullptr;
    void* recvBuf = nullptr;
    CommSymWindow sendWin = nullptr;
    CommSymWindow recvWin = nullptr;
    size_t sendOffset = 0;
    size_t recvOffset = 0;
    uint32_t rank = 0;
    uint32_t rankSize = 0;
...
#endif // OPS_HCCL_SYMMETRIC_ALLTOALL_COMMON_H
