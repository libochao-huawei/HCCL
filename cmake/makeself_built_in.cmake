...
execute_process(
    COMMAND python3 ${CPACK_CMAKE_SOURCE_DIR}/scripts/package/package.py --pkg_name hccl --os_arch linux-${CPACK_ARCH}
...
set(NN_VERSION_OUT_PUT
    ${CPACK_CMAKE_BINARY_DIR}/hccl_version.h
)
...
configure_file(
    ${CSV_OUTPUT}
    ${STAGING_DIR}/share/info/hccl/script/
    COPYONLY
)
configure_file(
    ${NN_VERSION_OUT_PUT}
...
execute_process(COMMAND bash ${MAKESELF_EXE}
        ...
        --help-header share/info/hccl/script/help.info
        ${makeself_param_string} share/info/hccl/script/install.sh
