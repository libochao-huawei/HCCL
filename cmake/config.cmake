...
if(HCCL_CANN_VERSION_NUM GREATER_EQUAL 90000000 AND HCCL_CANN_VERSION_NUM LESS 90100000)
    set(HCCL_CANN_COMPAT_900 ON)
    message(STATUS "HCCL_CANN_COMPAT_900 = ON (forward-compat mode for CANN >= 9.0.0 and CANN < 9.1.0)")
else()
    set(HCCL_CANN_COMPAT_900 OFF)
endif()
