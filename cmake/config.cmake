...
if(ENABLE_CUSTOM AND DEFINED CUSTOM_ONLY_HOST)
    if(CUSTOM_ONLY_HOST)
        set(KERNEL_MODE OFF)
        set(DEVICE_MODE OFF)
        message(STATUS "Custom only host mode enabled: building host package only for <<<>>> call (910_93 only)")
    else()
        set(KERNEL_MODE ON)
        set(DEVICE_MODE ON)
        message(STATUS "Custom only host mode disabled: building both host and device packages")
    endif()
endif()
