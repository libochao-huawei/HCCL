...
{
    CHK_PTR_NULL(opArgs);
    CHK_PRT(HcomCheckDataType(static_cast<HcclDataType>(srcDataType)));
...
{
    CHK_PTR_NULL(opArgs);
    CHK_PRT(HcomCheckDataType(static_cast<HcclDataType>(dstDataType)));
...
{
    CHK_PTR_NULL(opArgs);
    CHK_PRT(HcomCheckReductionOp(static_cast<HcclReduceOp>(reduceType)));
...
{
    CHK_PTR_NULL(opArgs);
    CHK_PRT(HcomCheckCommEngine(static_cast<CommEngine>(commEngine)));
