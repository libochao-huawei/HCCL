...
DEFINE_WEAK_FUNC(int32_t, HcommSendRequest, MsgHandle handle, const char* msgTag, const void* src, size_t sizeByte, uint32_t* msgId);
DEFINE_WEAK_FUNC(int32_t, HcommWaitResponse, MsgHandle handle, void* dst, size_t sizeByte, uint32_t* msgId);
