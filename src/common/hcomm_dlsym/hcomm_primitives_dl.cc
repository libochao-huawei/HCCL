...
DEFINE_WEAK_FUNC(int32_t, HcommBatchTransferOnThread, ThreadHandle thread, ChannelHandle channel,
...
void HcommPrimitivesDlInit(void* libHcommHandle) {
    ...
    INIT_SUPPORT_FLAG(libHcommHandle, HcommBatchTransferOnThread);
}
