    ...
    const OpParam &param, const AlgResourceCtxSerializable &resCtx)
{
    ...
    //     tempAlgParams.ccuKenels = resctx.ccuKenels;
    // } else {
    ...
    for (u64 loop = 0; loop < loopTimes; loop++) {
        ...
        // HCCL_INFO("[InsV2ReduceScatterVSoleExecutor] loop [%u] tempAlgParams.inputSliceStride [%u],"
...
// REGISTER_EXEC_V2(HcclCMDType::HCCL_CMD_REDUCE_SCATTER_V, AivReduceScatterVMesh1D, InsV2ReduceScatterVSoleExecutor, TopoMatch1D,
//     AivTempReduceScatterVMesh1D);

// REGISTER_EXEC_V2(HcclCMDType::HCCL_CMD_REDUCE_SCATTER_V, CcuReduceScatterVMesh1DMem2Mem, InsV2ReduceScatterVSoleExecutor, TopoMatch1D,
