...
enum AivOmniOpType : uint32_t {
    AIV_OMNI_OP_LOCAL_COPY = 3,
    AIV_OMNI_OP_LOCAL_REDUCE = 4,
    AIV_OMNI_OP_SEND_RECV_WRITE = 5,
    AIV_OMNI_OP_SEND_WRITE = 6,
    AIV_OMNI_OP_RECV_WRITE = 7,
    AIV_OMNI_OP_SEND_RECV_WRITE_REDUCE = 8,
    AIV_OMNI_OP_SEND_WRITE_REDUCE = 9,
    AIV_OMNI_OP_RECV_WRITE_REDUCE = 10,
    AIV_OMNI_OP_SEND_RECV_READ = 11,
    AIV_OMNI_OP_SEND_READ = 12,
    AIV_OMNI_OP_RECV_READ = 13,
    AIV_OMNI_OP_SEND_RECV_READ_REDUCE = 14,
    AIV_OMNI_OP_SEND_READ_REDUCE = 15,
    AIV_OMNI_OP_RECV_READ_REDUCE = 16,
    AIV_OMNI_OP_GROUP_BROAD_CAST = 17,
    AIV_OMNI_OP_GROUP_REDUCE = 18,
};
