...
HcclResutl CcuTempAllToAllVMesh1DMultiJetty::AddTaskArgA2AInfo(A2ASendRecvInfo &localSendRecvInfo, std::vector<uint64_t> &taskArgs)
{   
                                                        ...
                                                        TemplateResource& templateResource)
{
    ...
    CHK_RET(FillCachedArgs(submitInfo, buffInfo_.inBuffBaseOff, buffInfo_.outBuffBaseOff, 
                            ...
                            xnMaxTransportGoSize[2], xnMaxTransportGoSize[3]));
    ...
    const TemplateFastLaunchCtx& tempFastLaunchCtx)
{
    ...
    vector<uint64_t> taskArgsVec(args, args + argSize);
