...
constexpr u32 DIE_NUM_1 = 0;
constexpr u32 DIE_NUM_2 = 1;
...
HcclResult CcuTempAlltoAllVMesh1D::CalcChannelRes(HcclComm comm, const OpParam& param, const TopoInfoWithNetLayerDetails* topoInfo,
