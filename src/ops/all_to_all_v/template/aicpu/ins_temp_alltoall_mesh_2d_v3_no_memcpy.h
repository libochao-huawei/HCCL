...
#ifndef INS_TEMP_ALLTOALL_MESH_2D_V3_NO_MEMCPY_H
#define INS_TEMP_ALLTOALL_MESH_2D_V3_NO_MEMCPY_H
...
class InsTempAlltoAllMesh2DV3NoMemcpy : public InsAlgTemplateBase {
public:
    InsTempAlltoAllMesh2DV3NoMemcpy() = default;
    explicit InsTempAlltoAllMesh2DV3NoMemcpy(const OpParam &param, const u32 rankId,
                                      const std::vector<std::vector<u32>> &subCommRanks);
    ~InsTempAlltoAllMesh2DV3NoMemcpy() override;
...
#endif  // INS_TEMP_ALLTOALL_MESH_2D_V3_NO_MEMCPY_H
