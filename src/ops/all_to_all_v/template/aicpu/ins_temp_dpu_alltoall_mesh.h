...
#ifndef INS_TEMP_DPU_ALLTOALL_MESH_H
#define INS_TEMP_DPU_ALLTOALL_MESH_H
...
public:
    ...
    {
        std::string info = "Template of alltoall Mesh with tempRankSize ";
