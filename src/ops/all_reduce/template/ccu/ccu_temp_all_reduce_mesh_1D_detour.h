...
#ifndef HCCL_CCU_TEMP_ALL_REDUCE_MESH_1D_DETOUR_H
#define HCCL_CCU_TEMP_ALL_REDUCE_MESH_1D_DETOUR_H
...
public:
    ...
    ~CcuTempAllReduceMesh1DDetour() override;
...
private:
    ...
    HcclResult CalcKernelArgs();
    HcclResult CalcSliceInfo(const u64 dataSize, RankSliceInfo &sliceInfoVec);
    HcclResult CalcSliceInfoAllReduce(const u32 rankSize, const u64 dataSize, RankSliceInfo &sliceInfoVec);
