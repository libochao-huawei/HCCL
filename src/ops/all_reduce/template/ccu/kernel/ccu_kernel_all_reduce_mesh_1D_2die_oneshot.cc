...
HcclResult CcuKernelAllreduceMesh1D2DieOneShot::CreateMultiOpReduceWithoutMyRank(const std::vector<ChannelHandle>& channels, HcclDataType dataType,
...
HcclResult CcuKernelAllreduceMesh1D2DieOneShot::GroupReduceWithoutMyRank(const std::vector<ChannelHandle>& channels, CcuRep::LocalAddr &dst,
                                std::vector<CcuRep::RemoteAddr> &src, GroupOpSize &goSize, HcclDataType dataType,
                                HcclDataType outputDataType, HcclReduceOp opType)
{
    CHK_RET(CreateMultiOpReduceWithoutMyRank(channels, dataType, outputDataType, opType));
