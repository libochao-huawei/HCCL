...
struct CcuKernelArgAllReduceNHR1D : CcuKernelArgBase {
    ...
    CcuKernelSignature GetKernelSignature() const {
        CcuKernelSignature signature;
        GenerateCcuKernelSignature(signature, "CcuKernelArgAllReduceNHR1D", opParam, tempVTopo);
        return signature;
    }
};
...
struct AllReduceNHR1DContext: CcuKernelCtxBase {
    ...
    CcuVariable die0SliceSize;
    CcuVariable die1SliceSize;
    CcuVariable die0LastSliceSize;
    CcuVariable die1LastSliceSize;
