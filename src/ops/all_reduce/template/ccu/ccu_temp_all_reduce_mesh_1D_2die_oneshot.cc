...
namespace ops_hccl {
 #define ALL_REDUCE_2DIES_THREAD_NUM 2
                                                      ...
                                                      AlgResourceRequest& resourceRequest)
{
    ...
    // 多少个kernel
    resourceRequest.ccuKernelNum.push_back(ALL_REDUCE_2DIES_THREAD_NUM);
    ...
    for (uint32_t die = 0; die < ALL_REDUCE_2DIES_THREAD_NUM; die++) {
                                                        ...
                                                        const TemplateResource& templateResource)
{
    ...
    uint32_t dieNum             = ALL_REDUCE_2DIES_THREAD_NUM;
...
{
    return ALL_REDUCE_2DIES_THREAD_NUM;
}
