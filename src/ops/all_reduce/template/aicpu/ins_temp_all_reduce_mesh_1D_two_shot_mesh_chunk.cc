...
<<<<<<< HEAD
=======
u64 InsTempAllReduceMesh1DTwoShotMeshChunk::RoundUp(const u64 dividend, const u64 divisor)
{
    if (divisor == 0) {
        HCCL_WARNING("[InsTempAllReduceMesh1DTwoShotMeshChunk][RoundUp] divisor is 0.");
        return dividend;
    }
    return (dividend + divisor - 1) / divisor;
}

>>>>>>> 565974e11b89cb8ab262d65a2769b31ec85c3f18
} // ops_hccl