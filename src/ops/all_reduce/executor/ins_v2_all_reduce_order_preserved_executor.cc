    ...
    const OpParam &param, const AlgResourceCtxSerializable& resCtx)
{
    ...
    myRank_ = baseParams.myRank;
    rankSize_ = baseParams.rankSize;
    devType_ = baseParams.devType;
    dataCount_ = baseParams.dataCount;
    dataTypeSize_ = baseParams.dataTypeSize;
    dataSize_ = baseParams.dataSize;
    dataType_ = baseParams.dataType;
    reduceOp_ = baseParams.reduceOp;
    maxTmpMemSize_ = baseParams.maxTmpMemSize;
