...
{
    bool isStrictMode = (param.deterministicConfig == static_cast<u8>(DeterministicEnableLevel::DETERMINISTIC_STRICT))
    ...
    const OpParam &param, const AlgResourceCtxSerializable &resCtx)
{
    ...
    MemBlockInfo &memBlockInfo = tempAlgParams.memBlockInfo;
