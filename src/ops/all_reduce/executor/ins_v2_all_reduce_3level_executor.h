...
#ifndef HCCLV2_INS_ALL_REDUCE_3LEVEL_EXECUTOR_H
#define HCCLV2_INS_ALL_REDUCE_3LEVEL_EXECUTOR_H
...
class InsV2AllReduce3LevelExecutor : public InsCollAlgBase {
public:
    explicit InsV2AllReduce3LevelExecutor();
    ~InsV2AllReduce3LevelExecutor() = default;
