...
protected:
    ...
    HcclResult RunReduceScatter(const OpParam &param, TemplateDataParams &tempAlgParams,
    ...
    HcclResult RunAllGather(const OpParam &param, TemplateDataParams &tempAlgParams,
