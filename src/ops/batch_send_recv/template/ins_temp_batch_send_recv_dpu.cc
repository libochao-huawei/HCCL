        ...
        if (sendRecvChannel_.locationType == EndpointLocType::ENDPOINT_LOC_TYPE_HOST) {
            ...
            if (tempAlgParams.opType == BatchSendRecvOpType::SEND) {
                ...
                if (recvRank_ < myRank_) {
                    DataInfo sendInfo(sendRecvChannel_, sendSlicesList);
                } else {
                    DataInfo sendInfo(subSendRecvChannel_, sendSlicesList);
                }
                ...
                if (recvRank_ > myRank_) {
                    DataInfo recvInfo(sendRecvChannel_, recvSlicesList);
                } else {
                    DataInfo recvInfo(subSendRecvChannel_, recvSlicesList);
                }
