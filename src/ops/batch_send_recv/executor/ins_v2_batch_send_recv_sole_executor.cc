...
namespace ops_hccl {
template <typename InsAlgTemplate> InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::InsV2BatchSendRecvSoleExecutor()
{
}

template <typename InsAlgTemplate> std::string InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::Describe() const
{
...
template <typename InsAlgTemplate>
bool InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::SortSendItems(
...
template <typename InsAlgTemplate>
bool InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::SortRecvItems(
    const HcclSendRecvItem *a, const HcclSendRecvItem *b) const
{
    u32 aFlag = (a->remoteRank < static_cast<uint32_t>(myRank_)) ? (a->remoteRank + rankSize_) : a->remoteRank;
    u32 bFlag = (b->remoteRank < static_cast<uint32_t>(myRank_)) ? (b->remoteRank + rankSize_) : b->remoteRank;
...
template <typename InsAlgTemplate>
bool InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::SortSelfItems(
    const HcclSendRecvItem *a, const HcclSendRecvItem *b) const
{
    if (a->count != b->count) {
        return a->count > b->count;
...
template <typename InsAlgTemplate>
HcclResult InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::GetPairWiseList(
...
template <typename InsAlgTemplate> HcclResult InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::CalcSendSlices()
{
...
template <typename InsAlgTemplate> HcclResult InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::CalcRecvSlices()
{
...
template <typename InsAlgTemplate>
HcclResult InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::GetSendChannel(
...
template <typename InsAlgTemplate>
HcclResult InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::GetRecvChannel(
...
template <typename InsAlgTemplate>
HcclResult InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::ProcessSendDataSlice(
...
template <typename InsAlgTemplate>
HcclResult InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::ProcessRecvDataSlice(
...
template <typename InsAlgTemplate>
HcclResult InsV2BatchSendRecvSoleExecutor<InsAlgTemplate>::Orchestrate(
