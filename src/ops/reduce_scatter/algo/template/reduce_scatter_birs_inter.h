...
namespace ops_hccl {
class ReduceScatterBIRSInter : public AlgTemplateBase {
public:
...
protected:
private:
    HcclResult Preprocess(const u32 rank, const u32 rankSize, std::vector<ChannelInfo> &channels);
    ...
    HcclResult LocalCopyMainLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_,
                            u64 sliceSize, u64 localStrideSize);
    HcclResult FinalStep(const u32 rank, const u32 rankSize, u32 rankSizeX_, u64 sliceSize, u64 localStrideSize, std::vector<ChannelInfo> &channels);
