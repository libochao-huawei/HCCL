...
HcclResult ReduceScatterBIRSInter::HCCSProcessMainLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_, u64 sliceSize, u64 localStrideSize) 
{
...
HcclResult ReduceScatterBIRSInter::SIOProcessMainLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_, u64 sliceSize, u64 localStrideSize) 
{
...
HcclResult ReduceScatterBIRSInter::LocalCopyMainLoop(u32 round, const u32 rank, const u32 rankSize, u32 rankSizeX_, u64 sliceSize, u64 localStrideSize) 
{
...
HcclResult ReduceScatterBIRSInter::FinalStep(const u32 rank, const u32 rankSize, u32 rankSizeX_, u64 sliceSize, u64 localStrideSize, std::vector<ChannelInfo> &channels)
{
    std::vector<u32> vec;
...
HcclResult ReduceScatterBIRSInter::RunAsync(const u32 rank, const u32 rankSize, std::vector<ChannelInfo> &channels)
{
    ...
    FinalStep(rank, rankSize, rankSizeX_, sliceSize, localStrideSize, channels);
