...
HcclResult ReduceScatterBIRS::GetNotifyIdxMainToSub(std::vector<u32> &notifyIdxMainToSub)
{
...
HcclResult ReduceScatterBIRS::GetNotifyIdxSubToMain(std::vector<u32> &notifyIdxSubToMain)
{
