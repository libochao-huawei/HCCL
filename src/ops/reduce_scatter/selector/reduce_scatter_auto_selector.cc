                                                    ...
                                                    std::string &selectAlgName) const
{
    ...
    if (topoInfo->level0Topo == Level0Shape::MESH_1D) {
        ...
        // } else {
        //     selectAlgName = "CcuReduceScatterMesh1DMultiMission";
        // }
        selectAlgName = "CcuReduceScatterMesh1D";
    }
    // else if (topoInfo->level0Topo == Level0Shape::MESH_2D) {
    //     // if (dataSize < RS_2D_SMALL_DATA_SIZE) {
    //     //     selectAlgName = "CcuReduceScatterMesh2D";
    //     // } else {
    //     //     selectAlgName = "CcuReduceScatterMesh2DMultiMission";
    //     // }
    //     selectAlgName = "CcuReduceScatterMesh2D";
    // }
    else {
                                                    ...
                                                    std::string &selectAlgName) const
{
    ...
    if (topoInfo->topoLevelNums > 1) {
        ...
        //     selectAlgName = "CcuReduceScatterMesh2DMem2Mem";
        //     return SelectorStatus::MATCH;
        // }
        else {
