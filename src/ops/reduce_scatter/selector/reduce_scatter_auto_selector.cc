...
SelectorStatus ReduceScatterAutoSelector::SelectMeshAlgoAicpuForMesh1DClos(TopoInfoWithNetLayerDetails* topoInfo,
                                                                           OpParam &opParam, u64 dataSize, double ratio,
