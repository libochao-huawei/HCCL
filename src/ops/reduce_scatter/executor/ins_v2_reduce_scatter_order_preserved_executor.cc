    ...
    const AlgHierarchyInfoForAllLevel& algHierarchyInfo, AlgResourceRequest& resourceRequest)
{
    ...
    // InitExecutorInfo(param); // zdy 感觉没啥用
    // CalcSizePerBlock(param); // zdy 感觉没啥用
    // CalcGroupSlices(param); // zdy 感觉没啥用
    ...
    const OpParam &param, const AlgResourceCtxSerializable &resCtx)
{
    ...
    tempAlgParams.allRankSliceSize = memInfo_.groupSize; // zdy ??

    MemBlockInfo memBlockInfo;  // zdy 细节切分放到temp类里搞
