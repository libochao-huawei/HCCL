...
InsV2ReduceScatter3LevelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1,
                                   InsAlgTemplate2>::InsV2ReduceScatter3LevelExecutor()
{
}

template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
HcclResult
InsV2ReduceScatter3LevelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::InitCommInfo(
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
HcclResult InsV2ReduceScatter3LevelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::CalcRes(
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
HcclResult InsV2ReduceScatter3LevelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
HcclResult
InsV2ReduceScatter3LevelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::Orchestrate(
    const OpParam& param, const AlgResourceCtxSerializable& resCtx)
{
    HCCL_INFO("[InsV2ReduceScatter3LevelExecutor][Orchestrate] Orchestrate Start");
    // 参数填充
    ...
    CHK_PRT_RET(ret != HCCL_SUCCESS,
                HCCL_ERROR("[InsV2ReduceScatter3LevelExecutor][Orchestrate]errNo[0x%016llx] Reduce scatter excutor "
                           "kernel run failed",
                           HCCL_ERROR_CODE(ret)),
                ret);
    return HCCL_SUCCESS;
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
HcclResult
InsV2ReduceScatter3LevelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::RestoreChannelMap(
                                                                                   ...
                                                                                   const StepSliceInfo& stepSliceInfo)
{
    ...
    HCCL_INFO("[InsV2ReduceScatter3LevelExecutor] tempAlgParams.buffInfo.inBuffBaseOff [%u],"
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
HcclResult
InsV2ReduceScatter3LevelExecutor<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::OrchestrateLoop(
    const OpParam& param, const AlgResourceCtxSerializable& resCtx,
    std::map<u32, std::shared_ptr<InsAlgTemplateBase>> tempMap)
{
    HCCL_INFO("[InsV2ReduceScatter3LevelExecutor][OrchestrateLoop] Start");
    ...
    HCCL_INFO("[InsV2ReduceScatter3LevelExecutor][OrchestrateLoop]loopTimes = [%u]", loopTimes);
    ...
    for (u64 loop = 0; loop < loopTimes; loop++) {
        ...
        HCCL_INFO(
            "[InsV2ReduceScatter3LevelExecutor][OrchestrateLoop]level2 step count = [%u], level0 step count = [%u]",
        ...
        for (int i = 0; i < level2StepCount; i++) {
            HCCL_INFO("[InsV2ReduceScatter3LevelExecutor][OrchestrateLoop]Step [%u] in level2", i);
            if (rankSizeLevel2_ > 1) {
    ...
    HCCL_INFO("[InsV2ReduceScatter3LevelExecutor][OrchestrateLoop] End.");
    return HCCL_SUCCESS;
}

REGISTER_EXEC_V2_MULTI(HcclCMDType::HCCL_CMD_REDUCE_SCATTER, InsV2ReduceScatter3Level,
                       InsV2ReduceScatter3LevelExecutor, TopoMatch3Level, InsTempReduceScatterOmniPipeMesh1D,
