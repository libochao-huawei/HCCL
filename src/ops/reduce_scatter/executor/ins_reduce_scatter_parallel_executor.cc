...
REGISTER_EXECUTOR_BY_TWO_TEMPS(HcclCMDType::HCCL_CMD_REDUCE_SCATTER, InsReduceScatterParallelMesh2DNHR,
    InsReduceScatterParallelExecutor, TopoMatchMultilevel, InsTempReduceScatterMesh2D, InsTempReduceScatterNHR);
