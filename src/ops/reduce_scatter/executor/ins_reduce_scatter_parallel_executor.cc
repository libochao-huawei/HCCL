        ...
        const OpParam &param, const CcuFastLaunchCtx *resCtx)
{
    ...
    tempFastLaunchCtxIntra0.buffInfo.outputPtr = param.hcclMem.addr;
    tempFastLaunchCtxIntra0.buffInfo.hcclBuff = param.hcclMem;
    ...
    tempFastLaunchCtxInter1.buffInfo.outputPtr = param.hcclMem.addr;
    tempFastLaunchCtxInter1.buffInfo.hcclBuff = param.hcclMem;
    ...
    CHK_RET(PreSyncInterThreads(controlThread_, templateMainThreads_, notifyIdxControlToTemplates_));
    //数据0的server间的nhr算法
    tempFastLaunchCtxInter0.buffInfo.inputPtr = param.hcclMem.addr;
    tempFastLaunchCtxInter0.buffInfo.outputPtr = param.outputPtr;
    tempFastLaunchCtxInter0.buffInfo.hcclBuff = param.hcclMem;
    ...
    //数据1的server内的mesh算法
    tempFastLaunchCtxIntra1.buffInfo.inputPtr = param.hcclMem.addr;
    tempFastLaunchCtxIntra1.buffInfo.outputPtr = param.outputPtr;
    tempFastLaunchCtxIntra1.buffInfo.hcclBuff = param.hcclMem;
