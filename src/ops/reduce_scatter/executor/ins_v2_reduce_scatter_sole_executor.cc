...
REGISTER_EXEC_V2(HcclCMDType::HCCL_CMD_REDUCE_SCATTER, CcuReduceScatterMesh1DWrite, InsV2ReduceScatterSoleExecutor, TopoMatch1D,
    CcuTempReduceScatterMesh1DWrite);
