...
#ifndef INS_TEMP_REDUCE_SCATTER_OMNIPIPE_MESH_1D_NDA_H
#define INS_TEMP_REDUCE_SCATTER_OMNIPIPE_MESH_1D_NDA_H
...
class InsTempReduceScatterOmniPipeMesh1dNDA : public InsAlgTemplateBase {
public:
    explicit InsTempReduceScatterOmniPipeMesh1dNDA();
    explicit InsTempReduceScatterOmniPipeMesh1dNDA(const OpParam& param, const u32 rankId,
                                        const std::vector<std::vector<u32>> &subCommRanks);
    ~InsTempReduceScatterOmniPipeMesh1dNDA() override;
...
#endif // INS_TEMP_REDUCE_SCATTER_OMNIPIPE_MESH_1D_NDA_H
