...
InsTempReduceScatterMesh1DMeshChunkZAxisDetour::InsTempReduceScatterMesh1DMeshChunkZAxisDetour(
    const OpParam& param, const u32 rankId,
    const std::vector<std::vector<u32>> &subCommRanks)
    : InsTempReduceScatterMesh1DMeshChunk(param, rankId, subCommRanks)
{
}
...
HcclResult InsTempReduceScatterMesh1DMeshChunkZAxisDetour::CalcRes(
    HcclComm comm, const OpParam& param, const TopoInfoWithNetLayerDetails* topoInfo,
    AlgResourceRequest& resourceRequest)
{
    CHK_PRT_RET(topoInfo == nullptr,
        HCCL_ERROR("[MeshChunkZAxisDetour][CalcRes] topoInfo is nullptr"), HCCL_E_PARA);
    ...
    HCCL_INFO("[MeshChunkZAxisDetour][CalcRes] myRank[%u], channelsPerRank_[%u], "
...
HcclResult InsTempReduceScatterMesh1DMeshChunkZAxisDetour::CalcDataSplitByPortGroup(
...
{
    HCCL_INFO("[MeshChunkZAxisDetour][CalcDataSplitByPortGroup] Run Start");
...
HcclResult InsTempReduceScatterMesh1DMeshChunkZAxisDetour::SetchannelsPerRank(
    const std::map<u32, std::vector<ChannelInfo>> &channels)
{
    ...
    HCCL_INFO("[MeshChunkZAxisDetour][SetchannelsPerRank] channelsPerRank_[%u], "
              "level0ChannelNumPerRank_[%u], level1ChannelNumPerRank_[%u], level0DataRatio_[%.2f]",
