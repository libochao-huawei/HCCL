...
#ifndef HCCL_CCU_KERNEL_REDUCE_SCATTER_MESH_1D_FLATTEN
#define HCCL_CCU_KERNEL_REDUCE_SCATTER_MESH_1D_FLATTEN
...
class CcuKernelArgReduceScatterMesh1DFlatten : public CcuKernelArg {
public:
    explicit CcuKernelArgReduceScatterMesh1DFlatten(uint64_t dimSize, uint32_t rankId, const OpParam& opParam,
    ...
    {
        HCCL_DEBUG("[CcuKernelArgReduceScatterMesh1DFlatten] dimSize: %lu, rankId: %u, reduceOp: %d, dataType: %d",
    ...
    CcuKernelSignature GetKernelSignature() const override
    {
        ...
        GenerateCcuKernelSignature(signature, "CcuKernelArgReduceScatterMesh1DFlatten", opParam_, subCommRanks_);
        return signature;
    }
    uint64_t                                dimSize_;
    uint32_t                                rankId_;
...
class CcuTaskArgReduceScatterMesh1DFlatten : public CcuTaskArg {
public:
    explicit CcuTaskArgReduceScatterMesh1DFlatten(uint64_t inputAddr, uint64_t outputAddr, uint64_t token,
    ...
    {
        HCCL_INFO("[CcuTaskArgReduceScatterMesh1DFlatten] inputAddr: %lu, outputAddr: %lu, scratchAddr: %lu, "
...
class CcuKernelReduceScatterMesh1DFlatten : public CcuKernelAlgBase {
public:
    CcuKernelReduceScatterMesh1DFlatten(const CcuKernelArg &arg);
    ~CcuKernelReduceScatterMesh1DFlatten() override {}
...
#endif // HCCLV2_CCU_KERNEL_REDUCE_SCATTER_MESH_1D_FLATTEN
