...
#ifndef HCCL_CCU_TEMP_REDUCE_SCATTER_MESH_1D_H
#define HCCL_CCU_TEMP_REDUCE_SCATTER_MESH_1D_H
...
public:
    explicit CcuTempReduceScatterMesh1D(const OpParam& param, 
...
#endif // HCCL_CCU_TEMP_REDUCE_SCATTER_MESH_1D