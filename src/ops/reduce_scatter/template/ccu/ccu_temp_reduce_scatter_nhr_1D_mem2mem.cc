                                                         ...
                                                         AlgResourceRequest& resourceRequest)
{
    ...
    for (uint32_t kernelIdx = 0; kernelIdx < kernelNum; kernelIdx++) {
        ...
        strcpy(kernelInfo.kernelFuncName, "CcuKernelReduceScatterNHR1DMem2Mem");
                                                       ...
                                                       TemplateResource& templateResource)
{
    ...
    CHK_RET(FillCachedArgs(submitInfo, inputAddr, outputAddr, token, die0Size, die1Size,
        ...
        outputRepeatStride, repeatNumVar, isInputOutputEqual, buffInfo_.inBuffBaseOff, buffInfo_.outBuffBaseOff));
