                                                      ...
                                                      AlgResourceRequest& resourceRequest)
{
    ...
    strcpy(kernelInfo.kernelFuncName, "CcuReduceScatterMesh1DMem2MemKernel");
...
HcclResult CcuTempReduceScatterMesh1DMem2Mem::FastLaunch(const OpParam& param, const TemplateFastLaunchCtx& tempFastLaunchCtx)
{
    ...
    // FillCachedArgs末尾3个位置为base offset: args[15]=inBuffBaseOff, args[16]=outBuffBaseOff, args[17]=hcclBuffBaseOff
                                                        ...
                                                        TemplateResource& templateResource)
{
    ...
    // currentRankSliceInputOffset = inputSliceStride * mySubCommRank_
