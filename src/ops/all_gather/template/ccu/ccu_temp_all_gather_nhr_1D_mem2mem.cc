                                                       ...
                                                       TemplateResource& templateResource)
{
    ...
    HCCL_INFO("[CcuTempAllGatherNHR1DMem2Mem][KernelRun] isInputOutputEqual [%llu] and inputOutputEqual_original [%llu]", isInputOutputEqual, inputOutputEqual_original);
