                                                        ...
                                                        TemplateResource& templateResource)
{
    ...
    uint64_t inputOutputEqual = (inputAddr == outputAddr)? 1 : 0;
    ...
    HCCL_RUN_INFO("[CcuTempAllGatherMesh1DMem2Mem],inputAddr[%llu], "\
        ...
        inputAddr, outputAddr, repeatNum, inputSliceStride,
