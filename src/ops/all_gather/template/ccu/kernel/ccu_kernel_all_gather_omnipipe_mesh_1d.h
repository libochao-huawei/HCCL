...
#ifndef HCCL_CCU_KERNEL_ALL_GATHER_OMNIPIPE_MESH_1D_H
#define HCCL_CCU_KERNEL_ALL_GATHER_OMNIPIPE_MESH_1D_H
...
class CcuKernelArgAllGatherOmniPipeMesh1D : public CcuKernelArg {
public:
    explicit CcuKernelArgAllGatherOmniPipeMesh1D(uint64_t dimSize, uint32_t rankId, const OpParam& opParam,
    ...
    {
        HCCL_DEBUG("[CcuKernelArgAllGatherOmniPipeMesh1D] dimSize: %lu, rankId: %u, reduceOp: %d, dataType: %d",
    ...
    hcomm::CcuKernelSignature GetKernelSignature() const override
    {
        ...
        GenerateCcuKernelSignature(signature, "CcuKernelArgAllGatherOmniPipeMesh1D", opParam_, subCommRanks_);
        return signature;
    }
    uint64_t                                dimSize_;
    uint32_t                                rankId_;
...
class CcuTaskArgAllGatherOmniPipeMesh1D : public CcuTaskArg {
public:
    explicit CcuTaskArgAllGatherOmniPipeMesh1D(uint64_t inputAddr, uint64_t outputAddr, uint64_t token,
...
class CcuKernelAllGatherOmniPipeMesh1D : public CcuKernelAlgBase {
public:
    CcuKernelAllGatherOmniPipeMesh1D(const hcomm::CcuKernelArg &arg);
    ~CcuKernelAllGatherOmniPipeMesh1D() override {}
...
#endif // HCCL_CCU_KERNEL_ALL_GATHER_OMNIPIPE_MESH_1D_H
