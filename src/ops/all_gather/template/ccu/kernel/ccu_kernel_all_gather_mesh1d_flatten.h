...
#ifndef HCCL_CCU_KERNEL_ALL_GATHER_MESH_1D_FLATTEN_H
#define HCCL_CCU_KERNEL_ALL_GATHER_MESH_1D_FLATTEN_H
...
class CcuKernelArgAllGatherMesh1DFlatten : public hcomm::CcuKernelArg {
public:
    explicit CcuKernelArgAllGatherMesh1DFlatten(uint64_t dimSize, uint32_t rankId, const OpParam& opParam,
    ...
    {
        HCCL_DEBUG("[CcuKernelArgAllGatherMesh1DFlatten] dimSize: %lu, rankId: %u",
                   dimSize_, rankId_);
    }
    hcomm::CcuKernelSignature GetKernelSignature() const override
    {
        hcomm::CcuKernelSignature signature;
        GenerateCcuKernelSignature(signature, "CcuKernelArgAllGatherMesh1DFlatten", opParam_, subCommRanks_);
        return signature;
    }
    uint64_t                                dimSize_;
    uint32_t                                rankId_;
...
class CcuTaskArgAllGatherMesh1DFlatten : public hcomm::CcuTaskArg {
public:
    explicit CcuTaskArgAllGatherMesh1DFlatten(uint64_t inputAddr, uint64_t outputAddr, uint64_t token,
    ...
    {
        HCCL_DEBUG("[CcuTaskArgAllGatherMesh1DFlatten] inputAddr: %lu, outputAddr: %lu, inputSliceStride: %lu, "
...
class CcuKernelAllGatherMesh1DFlatten : public CcuKernelAlgBase {
public:
    CcuKernelAllGatherMesh1DFlatten(const hcomm::CcuKernelArg &arg);
    ~CcuKernelAllGatherMesh1DFlatten() override {}
...
#endif // HCCLV2_CCU_KERNEL_ALL_GATHER_MESH_1D_FLATTen_H
