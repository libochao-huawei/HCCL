...
#ifndef INS_TEMP_ALL_GATHER_MESH_1D_OPT_NO_MEMCPY_H
#define INS_TEMP_ALL_GATHER_MESH_1D_OPT_NO_MEMCPY_H
...
class InsTempAllGatherMesh1DOptNoMemcpy : public InsAlgTemplateBase {
public:
    InsTempAllGatherMesh1DOptNoMemcpy() = default;
    explicit InsTempAllGatherMesh1DOptNoMemcpy(const OpParam &param, const u32 rankId,  // 传通信域的rankId，userRank
                                    const std::vector<std::vector<u32>> &subCommRanks);
    // Host侧调用
    ~InsTempAllGatherMesh1DOptNoMemcpy() override;
