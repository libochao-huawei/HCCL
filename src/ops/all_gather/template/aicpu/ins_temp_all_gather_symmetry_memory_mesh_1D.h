...
class InsTempAllGatherSymmetryMemoryMesh1D : public InsAlgTemplateBase {
public:
    InsTempAllGatherSymmetryMemoryMesh1D() = default;
    explicit InsTempAllGatherSymmetryMemoryMesh1D(const OpParam &param, const u32 rankId,  // 传通信域的rankId，userRank
                                    const std::vector<std::vector<u32>> &subCommRanks);
    // Host侧调用
    ~InsTempAllGatherSymmetryMemoryMesh1D() override;
