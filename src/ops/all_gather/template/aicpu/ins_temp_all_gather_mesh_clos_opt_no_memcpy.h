...
#ifndef INS_TEMP_ALL_GATHER_MESH_CLOS_OPT_NO_MEMCPY_H
#define INS_TEMP_ALL_GATHER_MESH_CLOS_OPT_NO_MEMCPY_H

#include "ins_temp_all_gather_mesh_1D_opt_no_memcpy.h"

namespace ops_hccl {

class InsTempAllGatherMeshClosOptNoMemcpy : public InsTempAllGatherMesh1DOptNoMemcpy {
public:
    InsTempAllGatherMeshClosOptNoMemcpy() = default;
    explicit InsTempAllGatherMeshClosOptNoMemcpy(const OpParam &param, const u32 rankId,
                                        const std::vector<std::vector<u32>> &subCommRanks);
    ~InsTempAllGatherMeshClosOptNoMemcpy() override;
