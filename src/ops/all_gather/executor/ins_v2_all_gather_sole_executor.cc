...
// AICPU Ring Pipeline AllGather — 单线程环形流水线，链路负载均衡
REGISTER_EXEC_V2(HcclCMDType::HCCL_CMD_ALLGATHER, InsAllGatherRingPipeline, InsV2AllGatherSoleExecutor,
                 TopoMatch1D,
                 InsTempAllGatherRingPipeline);
#ifndef AICPU_COMPILE
