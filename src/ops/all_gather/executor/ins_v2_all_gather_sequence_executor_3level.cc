    ...
    AlgResourceRequest &resourceRequest)
{
    if (algHierarchyInfo.infos.size() != SEQUENCE_EXECUTOR_3_LEVEL_NUM) {
        HCCL_ERROR("[InsV2AllGatherSequenceExecutor3Level] algHierarchyInfo size %u should be %u", algHierarchyInfo.infos.size(), SEQUENCE_EXECUTOR_LEVEL_NUM);
    ...
    InsAlgTemplate2 crossTempAlg(param, topoInfo->userRank, algHierarchyInfo.infos[2]);
    
    // 调用计算资源的函数
    AlgResourceRequest intraTempRequest, interTempRequest, crossTempRequest;
    ...
    CHK_RET(crossTempAlg.CalcRes(comm, param, topoInfo, crossTempRequest));

    resourceRequest.notifyNumOnMainThread = std::max({intraTempRequest.notifyNumOnMainThread, interTempRequest.notifyNumOnMainThread, crossTempRequest.notifyNumOnMainThread});
    resourceRequest.slaveThreadNum = std::max({intraTempRequest.slaveThreadNum, interTempRequest.slaveThreadNum, crossTempRequest.slaveThreadNum});
    ...
    resourceRequest.notifyNumPerThread.insert(resourceRequest.notifyNumPerThread.end(),
                                              crossTempRequest.notifyNumPerThread.begin(),
                                              crossTempRequest.notifyNumPerThread.end());
    CHK_PRT_RET(intraTempRequest.channels.empty() || interTempRequest.channels.empty() || crossTempRequest.channels.empty(),
                     HCCL_ERROR("[InsV2AllGatherSequenceExecutor3Level][CalcRes] intraTemplate, interTemplate or crossTempRequest has empty channels."),
    ...
    resourceRequest.channels.emplace_back(crossTempRequest.channels[0]);
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
void InsV2AllGatherSequenceExecutor3Level<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::Orchestrate(
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
void InsV2AllGatherSequenceExecutor3Level<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::GenTemplateAlgParamsIntra0(
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
void InsV2AllGatherSequenceExecutor3Level<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::GenTemplateAlgParamsInter0(
    const OpParam &param, const AlgResourceCtxSerializable &resCtx, const u64 dataOffset,
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
void InsV2AllGatherSequenceExecutor3Level<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::GenTemplateAlgParamsInter1(
    const OpParam &param, const AlgResourceCtxSerializable &resCtx, const u64 dataOffset,
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
void InsV2AllGatherSequenceExecutor3Level<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::GenTemplateAlgParamsIntra1(
    const OpParam &param, const AlgResourceCtxSerializable &resCtx, const u64 dataOffset,
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
uint64_t InsV2AllGatherSequenceExecutor3Level<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::GetRankSize(
...
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
void InsV2AllGatherSequenceExecutor3Level<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::GetParallelDataSplit(
...
#ifndef AICPU_COMPILE
template <typename AlgTopoMatch, typename InsAlgTemplate0, typename InsAlgTemplate1, typename InsAlgTemplate2>
HcclResult InsV2AllGatherSequenceExecutor3Level<AlgTopoMatch, InsAlgTemplate0, InsAlgTemplate1, InsAlgTemplate2>::FastLaunchSaveCtx(
...
#ifndef AICPU_COMPILE
REGISTER_EXECUTOR_BY_THREE_TEMPS(HcclCMDType::HCCL_CMD_ALLGATHER, CcuAllGatherParallelMesh1DNHR,
    InsV2AllGatherSequenceExecutor3Level, TopoMatchMultilevel, CcuTempAllGatherMesh1DMem2Mem, CcuTempAllGatherNHR1DMem2Mem);
#endif
}
// 算法注册