...
__aicore__ inline void AivBroadcastMesh1D::ProcessBigData(uint64_t curCount, uint64_t sliceId)
{
    ...
    CalculateOffsetAndCount(targetRankCurCountStage1, rankSizeCoreDataIndex, coreNumPerRank, rankSizeCoreInnerDispls, rankSizeCoreSendCurCount);
    ...
    CalculateOffsetAndCount(rankSizeCoreSendCurCount, coreIndexStage1, rankSize_, innerDisplsStage1, sendCurCountStage1);
