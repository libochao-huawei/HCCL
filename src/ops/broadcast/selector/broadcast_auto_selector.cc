...
//         } else {
//             selectAlgName = "CcuBroadcastMeshMultiMission1D";
//         }
//     } else if (topoInfo->level0Topo == Level0Shape::MESH_2D) {
//         if(IsLargeData(dataSize)) {
//             selectAlgName = "CcuBroadcastMesh2DMultiMission";
//         } else {
//             selectAlgName = "CcuBroadcastMesh2D";
//         }
//     }
...
//                 return SelectorStatus::MATCH;
//             }else {
//                 selectAlgName = "CcuBroadcastNHRMem2Mem1D";
//                 return SelectorStatus::MATCH;
//             }
//         } else {
...
//             selectAlgName = "CcuBroadcastMeshMem2Mem1D";
//             return SelectorStatus::MATCH;
//         } else if ((IsDefaultAlg(levle0Algo) || levle0Algo == HcclAlgoType::HCCL_ALGO_TYPE_FULLMESH) && (topoInfo->level0Topo == Level0Shape::MESH_2D)) {
//             selectAlgName = "CcuBroadcastMeshMem2Mem2D";
//             return SelectorStatus::MATCH;
//         } else {
...
//         opParam.opType.Describe().c_str(), algos[0], algos[1], algos[2], algos[3]);
