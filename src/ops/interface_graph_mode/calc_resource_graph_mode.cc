...
#include "common/adapter_acl.h"
#include "op_common/executor/executor_v2_base.h"
#include "op_common/executor/registry/coll_alg_v2_exec_registry.h"
#include "op_common/template/aiv/hccl_aiv_utils.h"
