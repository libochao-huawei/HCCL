...
HcclResult CheckCalcResInput(OpParamGraphMode *opParam, u64 *opMemSize, u32 *streamNum, u32 *taskNum, u32 *aivCoreNum)
{
    if (opParam == nullptr) {
        return HCCL_E_PARA;
    }
...
HcclResult HcclCalcOpResOnlineGraphMode(OpParamGraphMode *opParam, u64 *opMemSize, u32 *streamNum, u32 *taskNum, u32 *aivCoreNum)
{
    ...
    CHK_RET(CheckCalcResInput(opParam, opMemSize, streamNum, taskNum, aivCoreNum));
    // 资源初始化
    *opMemSize = 0;
    *streamNum = 0;
    *taskNum = 0;
