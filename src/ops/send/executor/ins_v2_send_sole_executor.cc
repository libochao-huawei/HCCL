...
namespace ops_hccl
{
    ...
    template <typename InsAlgTemplate>
    HcclResult InsV2SendSoleExecutor<InsAlgTemplate>::CalcRes(HcclComm comm, const OpParam &param, const TopoInfo *topoInfo,
    ...
    REGISTER_EXECUTOR_IMPL_NO_TOPOMATCH(HcclCMDType::HCCL_CMD_SEND, HostDpuSend, InsV2SendSoleExecutor, InsTempSendDpu);
} // namespace ops_hccl