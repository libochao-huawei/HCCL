...
#include "template/aicpu/ins_temp_send_dpu.h"
...
namespace ops_hccl {
    ...
    REGISTER_EXECUTOR_IMPL_NO_TOPOMATCH(HcclCMDType::HCCL_CMD_SEND, opv2_insSendHostDpu, InsSendDpuExecutor, InsTempSendDpu);
} //namespace ops_hccl