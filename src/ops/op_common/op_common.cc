...
HcclResult SelectorAhead(HcclComm comm, OpParam &param, std::unique_ptr<TopoInfo> &topoInfo,
...
HcclResult HcclExecOpWithNoSelector(HcclComm comm, OpParam &param, std::unique_ptr<TopoInfo> &topoInfo, std::string &algName)
{
