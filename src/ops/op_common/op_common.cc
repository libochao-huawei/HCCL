                           ...
                           u32 aivCoreLimit, bool *ifAiv, char **algName)
{
    ...
    CHK_RET(HcclGetOpExpansionMode(hcclComm, param));
                                 ...
                                 void **commContext, u64 *len, u32 aivCoreLimit)
{
    ...
    *len = 0;
    ...
    if (opType == Hccl::OpType::ALLTOALL) {
        param.varMemSize = ops_hccl::ALL_TO_ALL_V_VECTOR_NUM * rankSize * sizeof(u64);
        opParams.all2AllVDataDes.sendType = dataType;
        opParams.all2AllVDataDes.recvType = dataType;
