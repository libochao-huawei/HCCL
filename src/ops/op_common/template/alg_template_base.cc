...
HcclResult AlgTemplateBase::ExecuteBarrier(ChannelInfo &channel, ThreadHandle thread) const
{
    ...
    CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(thread, channel.handle, NOTIFY_IDX_ACK,
    ...
    CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(thread, channel.handle, NOTIFY_IDX_DATA_SIGNAL,
        GetCurrentOpExecTimeout())));
...
HcclResult AlgTemplateBase::ExecuteBarrier(ChannelInfo &preChannel, ChannelInfo &aftChannel, ThreadHandle thread) const
{
    ...
    CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(thread, aftChannel.handle, NOTIFY_IDX_ACK,
        GetCurrentOpExecTimeout())));
    ...
    CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(thread, preChannel.handle, NOTIFY_IDX_DATA_SIGNAL,
        GetCurrentOpExecTimeout())));
...
HcclResult AlgTemplateBase::ExecuteBarrier(ChannelInfo &preChannel, ChannelInfo &aftChannel, u32 notifyIdx, ThreadHandle thread) const
{
    ...
    CHK_RET(static_cast<HcclResult>(HcommChannelNotifyWaitOnThread(thread, preChannel.handle, notifyIdx,
        GetCurrentOpExecTimeout())));
