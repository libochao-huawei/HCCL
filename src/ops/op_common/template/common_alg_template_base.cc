...
CommonAlgTemplateBase::CommonAlgTemplateBase(
...
// HcclResult CommonAlgTemplateBase::CalcDataSplitByPortGroup(const u64 totalDataCount, const u64 dataTypeSize,
...
// HcclResult CommonAlgTemplateBase::SetchannelsPerRank(const std::map<u32, std::vector<ChannelInfo>> &channels)
// {
