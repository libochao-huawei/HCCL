    ...
    std::vector<std::vector<HcclChannelDesc>>& channelsPerDie)
{
    ...
    if (portNum0 > portNum1) {
        ...
        std::cout << "rank[" << myRankId << "] portNum0 [" << portNum0 << "] > portNum1 [" << portNum1 << "]" << std::endl;
        std::cout << "channelsPerDie[0].size = " << channelsPerDie[0].size() << std::endl;
        std::cout << "channelsPerDie[1].size = " << channelsPerDie[1].size() << std::endl;
    }
