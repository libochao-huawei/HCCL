...
// HcclResult ClearAivSyncBuf(const AivOpArgs &opArgs)
// {
//     if ((opArgs.aivCountTag & AIV_LOW_16_BITS) == 1 && (opArgs.aivCountTag >> AIV_TAG_MOVE_LEFT_BITS) == 1) {
//         ACLCHECK(aclrtMemcpy(static_cast<u8*>(opArgs.buffersIn) + AIV_FLAG_ADDR_OFFSET, AIV_FLAG_AREA_SIZE,
//             static_cast<u8*>(opArgs.buffersIn) + AIV_FLAG_CLEAR_OFFSET, AIV_FLAG_AREA_SIZE, ACL_MEMCPY_DEVICE_TO_DEVICE));
//     }
//     HCCL_INFO("[ClearAivSyncBuf] clearaiv done.");
//     return HCCL_SUCCESS;
// }
