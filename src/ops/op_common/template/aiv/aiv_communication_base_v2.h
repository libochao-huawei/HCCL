...
GM_ADDR buffIn = reinterpret_cast<GM_ADDR>(args->buffersIn); \
...
GM_ADDR headCountMem = reinterpret_cast<GM_ADDR>(args->headCountMem); \
GM_ADDR tailCountMem = reinterpret_cast<GM_ADDR>(args->tailCountMem); GM_ADDR addOneMem = reinterpret_cast<GM_ADDR>(args->addOneMem); uint32_t counterMemSize = args->counterMemSize; bool isEnableCounter = args->isEnableCounter
