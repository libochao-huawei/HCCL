...
GM_ADDR buffIn = (GM_ADDR)(args->buffersIn); \
...
GM_ADDR headCountMem = (GM_ADDR)(args->headCountMem); \
GM_ADDR tailCountMem = (GM_ADDR)(args->tailCountMem); GM_ADDR addOneMem = (GM_ADDR)(args->addOneMem); uint32_t counterMemSize = args->counterMemSize; bool isEnableCounter = args->isEnableCounter
