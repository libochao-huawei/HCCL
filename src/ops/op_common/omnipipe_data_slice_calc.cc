...
std::vector<u64> CalcOmniPipeScratchInfo(OmniPipeScratchParam &omniPipeScratchParam)
{
    ...
    double xyB = xB;
    if(yB >= xB){
        CalcBandwidth2D(xB, yB, xRankSize, yRankSize, maxStepNum - 1);
    }
    else{
        CalcBandwidth2D(yB, xB, yRankSize, xRankSize, maxStepNum - 1);
    }
...
OmniPipeSliceInfo CalcAGOmniPipeSliceInfo(OmniPipeSliceParam &omniPipeSliceParam)
{
    ...
    if(yB >= xB){
        CalcBandwidth2D(xB, yB, xRankSize, yRankSize, maxStepNum);
    }
    else{
        CalcBandwidth2D(yB, xB, yRankSize, xRankSize, maxStepNum);
    }
