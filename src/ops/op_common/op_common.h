...
HcclResult HcclAllocAlgResourceAivGraphMode(const HcclComm comm, const OpParam &param, const AlgResourceRequest &resRequest, const AlgResourceCtxSerializable* resCtxHost);
