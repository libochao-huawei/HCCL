...
constexpr u32 AICPU_NOTIFY_DEFAULT_WAIT_TIMEOUT = 27 * 68; // 1836s, 默认非AIV(HOST/HOST_TS)模式超时时间
constexpr u32 AICPU_NOTIFY_AIV_DEFAULT_WAIT_TIMEOUT = 1091; // 默认AIV模式超时时间
...
{
    CurrentOpExecTimeoutRef() = timeout;
}
