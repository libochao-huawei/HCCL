                                                        ...
                                                        TemplateResource& templateResource)
{
    ...
    uint64_t inputAddr          = PointerToAddr(buffInfo_.inputPtr) + templateDataParams.outputSliceStride;
    uint64_t outputAddr         = PointerToAddr(buffInfo_.outputPtr) + templateDataParams.outputSliceStride;
    uint64_t token;
