...
// HcclResult AllocAlgResourceReduce(HcclComm comm, const OpParam& param, AlgResourceRequest &resRequest,
//     AlgResourceCtx* resCtxHost, aclrtNotify* notifies);

// HcclResult CalcBaseTopoInfoReduce(HcclComm comm, OpParam &param, TopoInfo **topoInfo);
}  // namespace ops_hccl
