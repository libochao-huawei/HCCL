...
#ifndef HCCL_CCU_TEMP_REDUCE_MESH_2D_MEM2MEM_H
#define HCCL_CCU_TEMP_REDUCE_MESH_2D_MEM2MEM_H
...
public:
    explicit  CcuTempReduceMeshMem2Mem2D(const OpParam& param,
    ...
    {
        return StringFormat("Template of Reduce ccu mesh 2D Mem2Mem with tempRankSize [%u].",
...
#endif// HCCL_CCU_TEMP_REDUCE_MESH_2D_MEM2MEM_H