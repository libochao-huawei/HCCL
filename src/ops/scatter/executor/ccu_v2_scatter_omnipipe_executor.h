...
class CcuV2ScatterOmniPipeExecutor : public InsCollAlgBase {
public:
    explicit CcuV2ScatterOmniPipeExecutor();
    ~CcuV2ScatterOmniPipeExecutor() = default;
...
protected:
    ...
    bool isSameXAxisAsRoot;  //和root同x轴
    bool isSameYAxisAsRoot;  //和root同y轴
    ...
    HcclResult GenTempAlgParamsIn2HCCLBuff(TemplateDataParams &tempAlgParams, StepSliceInfo &stepSliceInfo, u64 processedDataCount, const AlgResourceCtxSerializable &resCtx);
    HcclResult GenTempAlgParamsIn2OUT(TemplateDataParams &tempAlgParams, StepSliceInfo &stepSliceInfo, u64 processedDataCount, const AlgResourceCtxSerializable &resCtx);
    HcclResult GenTempAlgParamsHCCLBuff2OUT(TemplateDataParams &tempAlgParams, StepSliceInfo &stepSliceInfo, u64 processedDataCount, const AlgResourceCtxSerializable &resCtx);
