...
REGISTER_EXEC_V2_MULTI(HcclCMDType::HCCL_CMD_SCATTER, CcuV2ScatterOmniPipe, CcuV2ScatterOmniPipeExecutor, TopoMatchMultilevel, CcuTempScatterOmniPipeMesh1D, CcuTempScatterOmniPipeMesh1D);
