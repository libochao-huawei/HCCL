                                               ...
                                               AlgResourceRequest &resourceRequest)
{
    ...
    for (uint32_t kernelIdx = 0; kernelIdx < kernelNum; kernelIdx++) {
        ...
        strcpy(kernelInfo.kernelFuncName, "CcuKernelScatterNHR1DMem2Mem1D");
                                                 ...
                                                 TemplateResource& templateResource)
{
    ...
    submitInfo.cachedArgs[9]=sliceSize * repeatNum; // curScratchStride
    submitInfo.cachedArgs[10]=inputRepeatStride;
    submitInfo.cachedArgs[11]=outputRepeatStride;
    submitInfo.cachedArgs[12]=UINT64_MAX - repeatNum;
    submitInfo.cachedArgs[13]=isOutputScratch;
    submitInfo.cachedArgs[14]=isInputOutputEqual;
    submitInfo.cachedArgs[15]=die0TailSize;
    submitInfo.cachedArgs[16]=die1TailSize;
    submitInfo.cachedArgs[17]=isSliceSizeZero;
