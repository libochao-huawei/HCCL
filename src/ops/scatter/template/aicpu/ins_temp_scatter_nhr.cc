...
HcclResult InsTempScatterNHR::SplitDataPerChannel(const DataSlice &srcSlice, const DataSlice &dstSlice, const std::vector<ChannelInfo> &channels, std::vector<DataSlice> &srcSliceVec, std::vector<DataSlice> &dstSliceVec) const {
    srcSliceVec.clear();
    dstSliceVec.clear();
    ...
    const std::vector<ThreadHandle> &threads, const TemplateDataParams &tempAlgParam, u32 repeat) const
{
    ...
    std::vector<vector<DataSlice>> srcSlices(activateChannelNum);
    std::vector<vector<DataSlice>> dstSlices(activateChannelNum);
    ...
    const std::vector<ThreadHandle> &threads, const TemplateDataParams &tempAlgParam, u32 repeat) const
{
    ...
    std::vector<vector<DataSlice>> txSrcSlices(sendChannelNum);
    std::vector<vector<DataSlice>> txDstSlices(sendChannelNum);
    ...
    std::vector<vector<DataSlice>> rxSrcSlices(recvChannelNum);
    std::vector<vector<DataSlice>> rxDstSlices(recvChannelNum);
