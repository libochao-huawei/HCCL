...
extern "C" uint64_t (*hcommGetProfilingSysCycleTimePtr)() = nullptr;
extern "C" HcclResult (*hcommProfilingReportOpPtr)(HcomProInfoTmp) = nullptr;
extern "C" HcclResult (*hcommProfilingReportKernelPtr)(uint64_t, const char *) = nullptr;
extern "C" HcclResult (*hcommProfilingRegThreadPtr)(HcomProInfoTmp, ThreadHandle *) = nullptr;
extern "C" HcclResult (*hcommProfilingInitPtr)(ThreadHandle *, uint32_t) = nullptr;
extern "C" HcclResult (*hcommProfilingReportMainStreamAndFirstTaskPtr)(ThreadHandle) = nullptr;
extern "C" HcclResult (*hcommProfilingReportMainStreamAndLastTaskPtr)(ThreadHandle) = nullptr;
extern "C" HcclResult (*hcommProfilingReportDeviceHcclOpInfoPtr)(HcomProInfoTmp) = nullptr;
extern "C" HcclResult (*hcommProfilingEndPtr)(ThreadHandle *, uint32_t) = nullptr;
