...
constexpr uint32_t DATATYPE_SIZE_TABLE_RS_DPU_ST[HCCL_DATA_TYPE_RESERVED] = {sizeof(int8_t), sizeof(int16_t),
...
void RunReduceScatterDPUA5(const TopoMeta &topoMeta, u64 recvCount, HcclDataType dataType, HcclReduceOp reduceOp)
{
    ...
    size_t dataUnitSize = DATATYPE_SIZE_TABLE_RS_DPU_ST[dataType];
...
TEST_F(ST_REDUCE_SCATTER_TEST, test_host_dpu_reducescatter_001)
{
    ...
    RunReduceScatterDPUA5(topoMeta, recvCount, dataType, reduceOp);
}
