...
// // 1卡1机100个int32（自收发用例）
// TEST_F(ST_SEND_RECV_TEST, st_send_recv_1d_1r_int32_c100_test) {
//     TopoMeta topoMeta{{{0}}};
//     std::map<RankId, RankId> sendRecvMap = {{0, 0}};
//     auto dataCount = 100;
...
// // 2卡1机0个int32，数据量为0用例
// TEST_F(ST_SEND_RECV_TEST, st_send_recv_1d_3r_int32_0_test) {
//     TopoMeta topoMeta{{{0, 1}}};
//     std::map<RankId, RankId> sendRecvMap = {{0, 1}};
//     auto dataCount = 0;
//     auto dataType = HcclDataType::HCCL_DATA_TYPE_INT32;
