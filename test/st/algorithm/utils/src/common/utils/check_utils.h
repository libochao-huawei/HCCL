...
void CalcInputOutputSize(HcclCMDType opType, uint32_t rankSize, uint64_t count, HcclDataType dataType,
    u64 &inputSize, u64 &outputSize, RankId myRank, RankId srcRank = 0, RankId dstRank = 0, VDataDesTag vDataDes = VDataDesTag{}, All2AllDataDesTag all2AllDataDes = All2AllDataDesTag{});
