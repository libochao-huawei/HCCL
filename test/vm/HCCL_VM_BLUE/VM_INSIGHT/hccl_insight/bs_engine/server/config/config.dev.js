module.exports = {
  ...
  host: '7.203.215.145',
  port: 3306,
  foundation: 'http://haekwe-dev4.huawei.com/panshi/foundation',
  common: 'http://haekwe-dev4.huawei.com/panshi/common',
  ...
  callbackUrl: { Process_Data_import: 'http://haekwe-dev4.huawei.com/panshi/common/process/review/process' }
};
