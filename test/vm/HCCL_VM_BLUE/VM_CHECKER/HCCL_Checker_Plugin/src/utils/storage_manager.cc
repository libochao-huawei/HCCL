...
HcclResult StorageManager::LoadHcclVmTaskMetaData()
{
    ...
    for (auto &taskMeta : m_taskMeataData.task_meta) {
        HCCL_VM_INFO("[LoadHcclVmTaskMetaData] rankId= {}, dieId= {}, instrCnt= {}, argSize= {}",
            taskMeta.rankId, static_cast<uint32_t>(taskMeta.taskData.ccu.dieId), taskMeta.taskData.ccu.instCnt, taskMeta.taskData.ccu.argSize);
    }
