...
private:
    ...
    Table<sim::RaDevice> raDeviceTbl{"RaDevice"};
    Table<sim::RaQP> raQPTbl{"RaQP"};
    Table<sim::RaCQ> raCQTbl{"RaCQ"};
    Table<sim::RaCQE> raCQETbl{"RaCQE"};
    Table<sim::RaMR> raMRTbl{"RaMR"};
    ...
    SimRunnerMemDB()
    {
        ...
        RegisterTable<sim::RaDevice>(raDeviceTbl);
        RegisterTable<sim::RaQP>(raQPTbl);
        RegisterTable<sim::RaCQ>(raCQTbl);
        RegisterTable<sim::RaCQE>(raCQETbl);
        RegisterTable<sim::RaMR>(raMRTbl);
