...
// extern  std::map<HcclReduceOp, ReduceOp> g_CheckerReduceOp2ReduceOp_aicpu;
// extern  std::map<ReduceOp, HcclReduceOp> g_ReduceOp2CheckerReduceOp_aicpu;
// extern  std::map<HcclDataType, DataType> g_CheckerDataType2DataType_aicpu;
...
// extern  std::map<uint16_t, HcclDataType> g_DataType2CheckerDataType_ccu;
