...
#ifndef OPS_BUILT_IN_OP_PROTO_INC_HCOM_OPS_H_WARN_SHOWN
#define OPS_BUILT_IN_OP_PROTO_INC_HCOM_OPS_H_WARN_SHOWN
#warning "hcom_ops.h is scheduled to be deprecated in December 2026, and will be replaced by the \
 ...
 * @par Restrictions:
 * Warning: THIS FUNCTION IS DEPRECATED. Please do not use it.
*/
...
#endif // OPS_BUILT_IN_OP_PROTO_INC_HCOM_OPS_H_WARN_SHOWN
