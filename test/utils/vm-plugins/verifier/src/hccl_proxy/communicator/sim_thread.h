...
class SimHcclThread {
public:
    SimHcclThread(rtStream_t rtStream, u32 notifyNum, const hccl::NotifyLoadType notifyLoadType);
    SimHcclThread(hccl::StreamType streamType, u32 notifyNum, const hccl::NotifyLoadType notifyLoadType);
    ~SimHcclThread();
