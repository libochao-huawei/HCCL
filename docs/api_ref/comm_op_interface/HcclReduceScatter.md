...
| op | 输入 | Reduce的操作类型，目前支持操作类型为sum、prod、max、min。<br> 说明： 针对Ascend 950PR/Ascend 950DT，支持的操作类型为sum、max、min。<br>针对Atlas A3 训练系列产品/Atlas A3 推理系列产品，当前版本“prod”操作不支持int16、bfp16数据类型。<br>针对Atlas A2 训练系列产品/Atlas A2 推理系列产品，当前版本“prod”操作不支持int16、bfp16数据类型。<br>针对Atlas 300I Duo 推理卡，当前版本“prod”、“max”、“min”操作不支持int16数据类型。 |
